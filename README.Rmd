...
Van Bavel, C. H. M. (1949). Mean weight diameter of soil aggregates as a statistical index of aggregation. Soil Science Society of America Journal, 14, 20-23. (Proponente do DMP).

Mazurak, A. P. (1950). Aggregation of colloidal clay from Hesperia sandy loam as affected by types of substituted cations. Soil Science Society of America Journal, 15, 18-24. (Proponente do DMG).
